export const projects = [
  ...
  },
  {
    ...
    client: "Akari Sushi",
    description: "A essência do Japão em traços modernos e sofisticados.",
    challenge: "O Akari nasceu do desafio de respeitar a tradição japonesa sem cair no clichê dos logotipos em vermelho e preto, rompendo com o padrão visual previsível.",
    strategy: "Unimos minimalismo e sofisticação em uma atmosfera íntima, com tipografia que reforça a exclusividade e uma paleta que captura a essência da gastronomia oriental moderna.",
    results: "Uma experiência visual memorável que reflete a culinária do Akari: simples, refinada e longe do óbvio.",
    gallery: [
